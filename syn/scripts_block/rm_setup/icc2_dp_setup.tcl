...
#set_host_options -name block_script -submit_command [list qsub -P bnormal -l mem_free=6G,qsc=l|m -cwd]
...
##########################################################################################
set DP_BLOCK_REFS                     [list] ;# design names for each physical block in the design;
                                             ;# this includes bottom and mid level blocks in a 
                                             ;# Multiple Physical Hierarchy (MPH) design
...
# 				PRE_SHAPING
##########################################################################################
set TCL_USER_PRE_SHAPING_PRE_SCRIPT  "" ;# An optional Tcl file to be sourced at the very begining of the task
...
set TCL_USER_PLACE_IO_PRE_SCRIPT     "" ;# An optional Tcl file to be sourced at the very end of the task
...
set TCL_USER_SHAPING_PRE_SCRIPT     "" ;# An optional Tcl file to be sourced at the very end of the task
...
set TCL_USER_PLACEMENT_PRE_SCRIPT       ""  ;# An optional Tcl file to be sourced at the very end of the task
...
set TCL_USER_CREATE_POWER_PRE_SCRIPT  "" ;# An optional Tcl file to be sourced at the very end of the task
...
set TCL_USER_PLACE_PINS_PRE_SCRIPT  "" ;# An optional Tcl file to be sourced at the very end of the task
...
set TCL_USER_PRE_TIMING_PRE_SCRIPT    "" ;# An optional Tcl file to be sourced at the very end of the task
...
set TCL_USER_TIMING_ESTIMATION_PRE_SCRIPT  "" ;# An optional Tcl file to be sourced at the very end of the task
...
set TCL_USER_BUDGETING_PRE_SCRIPT     "" ;# An optional Tcl file to be sourced at the very end of the task
