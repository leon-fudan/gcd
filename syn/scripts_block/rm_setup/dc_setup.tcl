...
source ./scripts_block/rm_icc2_user_scripts/proc_qor.tcl
source ./scripts_block/rm_icc2_user_scripts/proc_auto_weights.tcl
...
set RTL_SOURCE_FILES  "/u/weihang/work@ailab1/nvdla_syn/nvdla_syn/rtl/nvdla.small.vc"      ;# Enter the list of source RTL files if reading from RTL

# The following variables are used by scripts in the rm_dc_scripts folder to direct 
# the location of the output files.

set REPORTS_DIR "rpts/dc/"
set RESULTS_DIR "outputs/dc/"
