...
set DCRM_GROUP_PATH_FILE                                ${DESIGN_NAME}.group_path.tcl
...
set DCRM_COMPILE_ULTRA_QOR_REPORT                       ${DESIGN_NAME}.compile_ultra.qor.rpt
set DCRM_COMPILE_ULTRA_TIMING_REPORT_GROUP              ${DESIGN_NAME}.compile_ultra.timing.group.rpt
set DCRM_COMPILE_ULTRA_TIMING_REPORT_SLACK              ${DESIGN_NAME}.compile_ultra.timing.slack.rpt

set DCRM_FINAL_QOR_REPORT                               ${DESIGN_NAME}.mapped.qor.rpt
set DCRM_FINAL_TIMING_REPORT_GROUP                      ${DESIGN_NAME}.mapped.timing.group.rpt
set DCRM_FINAL_TIMING_REPORT_SLACK                      ${DESIGN_NAME}.mapped.timing.slack.rpt
...
set DCRM_NON_DEFAULT_SETTING_REPORT                     ${DESIGN_NAME}.non_default_setting.rpt
set DCRM_CPU_RUNTIME_REPORT                             ${DESIGN_NAME}.cpu_runtime.rpt
...
set DCRM_ELABORATED_DESIGN_VERILOG_OUTPUT_FILE          ${DESIGN_NAME}.elab.v
set DCRM_COMPILE_ULTRA_DDC_OUTPUT_FILE                  ${DESIGN_NAME}.compile_ultra.ddc
set DCRM_COMPILE_ULTRA_VERILOG_OUTPUT_FILE              ${DESIGN_NAME}.compile_ultra.v
...
set DCRM_DFT_SETUP_FILE                                 ${DESIGN_NAME}.dft_setup.tcl
